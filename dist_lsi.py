...
'''
read http://radimrehurek.com/gensim/dist_lsi.html
here is test code
'''
...
'''
python2.7 dist_lsi.py --dictionary=document.txt.dict --corpus=document.txt.mm --lsi=document.txt.lsi
'''
if __name__ == '__main__':
    ...
    lsi = corpus_to_lsi_dist(corpus, dictionary, 200)
